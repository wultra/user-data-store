...
CREATE TABLE uds_document (id VARCHAR2(36) NOT NULL, user_id VARCHAR2(255) NOT NULL, document_type VARCHAR2(32) NOT NULL, data_type VARCHAR2(32) NOT NULL, document_data_id VARCHAR2(255), external_id VARCHAR2(255), document_data CLOB NOT NULL, attributes CLOB NOT NULL, encryption_mode VARCHAR2(255) DEFAULT 'NO_ENCRYPTION' NOT NULL, timestamp_created TIMESTAMP DEFAULT NOW(), timestamp_last_updated TIMESTAMP, CONSTRAINT PK_UDS_DOCUMENT PRIMARY KEY (id));

-- Changeset docs/db/changelog/changesets/user-data-store/1.3.x/20240514-refactor-uds-1.3.0.xml::2::Roman Strobl
CREATE TABLE uds_document_history (id VARCHAR2(36) NOT NULL, document_id VARCHAR2(36) NOT NULL, user_id VARCHAR2(255) NOT NULL, document_type VARCHAR2(32) NOT NULL, data_type VARCHAR2(32) NOT NULL, document_data_id VARCHAR2(255), external_id VARCHAR2(255), document_data CLOB NOT NULL, attributes CLOB NOT NULL, encryption_mode VARCHAR2(255) DEFAULT 'NO_ENCRYPTION' NOT NULL, timestamp_created TIMESTAMP DEFAULT NOW(), CONSTRAINT PK_UDS_DOCUMENT_HISTORY PRIMARY KEY (id));

-- Changeset docs/db/changelog/changesets/user-data-store/1.3.x/20240514-refactor-uds-1.3.0.xml::3::Roman Strobl
CREATE TABLE uds_photo (id VARCHAR2(36) NOT NULL, user_id VARCHAR2(255) NOT NULL, document_id VARCHAR2(255) NOT NULL, external_id VARCHAR2(255), photo_type VARCHAR2(32) NOT NULL, photo_data CLOB NOT NULL, encryption_mode VARCHAR2(255) DEFAULT 'NO_ENCRYPTION' NOT NULL, timestamp_created TIMESTAMP DEFAULT NOW(), timestamp_last_updated TIMESTAMP, CONSTRAINT PK_UDS_PHOTO PRIMARY KEY (id));
...
CREATE TABLE uds_attachment (id VARCHAR2(36) NOT NULL, user_id VARCHAR2(255) NOT NULL, document_id VARCHAR2(255) NOT NULL, external_id VARCHAR2(255), attachment_type VARCHAR2(32) NOT NULL, attachment_data CLOB NOT NULL, encryption_mode VARCHAR2(255) DEFAULT 'NO_ENCRYPTION' NOT NULL, timestamp_created TIMESTAMP DEFAULT NOW(), timestamp_last_updated TIMESTAMP, CONSTRAINT PK_UDS_ATTACHMENT PRIMARY KEY (id));
