...
You can also run Liquibase manually using the [Liquibase CLI](https://docs.liquibase.com/tools-integrations/cli/home.html). In the User Data Store distribution, the main changelog file is `./docs/db/changelog/db.changelog-master.xml` relative to the `docs/` directory:
